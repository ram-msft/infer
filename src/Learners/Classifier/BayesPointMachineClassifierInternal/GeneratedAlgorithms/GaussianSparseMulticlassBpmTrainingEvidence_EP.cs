...
namespace Microsoft.ML.Probabilistic.Learners.BayesPointMachineClassifierInternal
{
	public partial class GaussianSparseMulticlassBpmTrainingEvidence_EP : IGeneratedAlgorithm
	{
		...
		public DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]> ModelSelector_selector_cases_0_rep28_rep_B;
		...
		public bool[][][] vbool44;
		public DistributionRefArray<DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>,double[][]> vdouble418_B;
		...
		private void Changed_ClassCount()
		{
			...
			this.ModelSelector_selector_cases_0_rep11_B = new DistributionStructArray<Bernoulli,bool>(this.classCount);
			for(int ClassRange = 0; ClassRange<this.classCount; ClassRange++) {
		...
		private void Changed_ClassCount_FeatureCount_FeatureIndexes_FeatureValues_InstanceCount_InstanceFeatureCounts_Lab12(int numberOfIterations)
		{
			...
			for(int ClassRange = 0; ClassRange<this.classCount; ClassRange++) {
				this.ModelSelector_selector_cases_0_rep11_uses_B[ClassRange][1] = Bernoulli.FromLogOdds(JaggedSubarrayOp<double>.LogEvidenceRatio<Gaussian,DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>,DistributionStructArray<Gaussian,double>>(this.Weights_FeatureIndexes_B[ClassRange], this.Weights_depth1_F[ClassRange], this.featureIndexes, this.Weights_FeatureIndexes_F[ClassRange]));
		...
		private void Changed_ClassCount_InstanceCount()
		{
			...
			for(int InstanceRange = 0; InstanceRange<this.instanceCount; InstanceRange++) {
				...
				this.ModelSelector_selector_cases_0_rep28_rep_B[InstanceRange] = new DistributionStructArray<Bernoulli,bool>(this.classCount);
			}
		...
		private void Changed_ClassCount_InstanceCount_Labels()
		{
			...
			for(int InstanceRange = 0; InstanceRange<this.instanceCount; InstanceRange++) {
				...
				this.vdouble418_B[InstanceRange] = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(this.classCount);
				for(int ClassMaxNoisyScore = 0; ClassMaxNoisyScore<this.classCount; ClassMaxNoisyScore++) {
					if (this.labels[InstanceRange]==ClassMaxNoisyScore) {
						this.vdouble418_B[InstanceRange][ClassMaxNoisyScore] = new DistributionStructArray<Gaussian,double>(this.classCount);
					}
				}
					...
					for(int ClassMaxNoisyScore = 0; ClassMaxNoisyScore<this.classCount; ClassMaxNoisyScore++) {
						if (this.labels[InstanceRange]==ClassMaxNoisyScore) {
							if (ClassMaxNoisyScore!=ClassRange) {
								...
								this.ModelSelector_selector_cases_0_rep28_rep_B[InstanceRange][ClassRange] = Bernoulli.FromLogOdds(ConstrainEqualOp<bool>.LogEvidenceRatio(true, this.vbool44[InstanceRange][ClassMaxNoisyScore][ClassRange]));
							}
						}
					}
				}
		...
		private void Changed_FeatureCount()
		{
			...
			this.ModelSelector_selector_cases_0_rep31_B = new DistributionStructArray<Bernoulli,bool>(this.featureCount);
			for(int FeatureRange = 0; FeatureRange<this.featureCount; FeatureRange++) {
		...
		private void Changed_InstanceCount()
		{
			...
			this.vdouble418_B = new DistributionRefArray<DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>,double[][]>(this.instanceCount);
			...
			this.ModelSelector_selector_cases_0_rep16_B = new DistributionStructArray<Bernoulli,bool>(this.instanceCount);
			for(int InstanceRange = 0; InstanceRange<this.instanceCount; InstanceRange++) {
			...
			this.ModelSelector_selector_cases_0_rep28_rep_B = new DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>(this.instanceCount);
			for(int InstanceRange = 0; InstanceRange<this.instanceCount; InstanceRange++) {
